...
import 'package:prueba/Formulario.dart';
import 'package:prueba/Imagenes.dart';
import 'package:prueba/Listas.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  final screens = [Textos(),Botones(),Imagenes(),Navegacion(),Formulario(),Listas()];
  int selectedIndex = 0;
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                  icon: Icon(Icons.format_align_center_rounded), label: "Formularios"),
                BottomNavigationBarItem(
